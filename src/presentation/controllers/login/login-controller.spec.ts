...
import { ok, serverError, unauthorizedError } from '../../helpers/http/http-helper'
...
const makeAuthentication = (): Authentication => {
  class AuthenticationStub implements Authentication {
    async auth (authentiction: AuthenticationModel): Promise<string> {
...
describe('Login Controller', () => {
  ...
  test('Should return 500 if authentiction throws', async () => {
    const { sut, authenticationStub } = makeSut()
